...
Holepunching is the `art` of connecting to your peers over the many layers of internet that hate you, want to eat your children, and don't want you connecting peer to peer.

For an intro from the Godfather of P2P himself:

<YouTube id="https://www.youtube.com/watch?v=QWWHKLyCFTU" />
